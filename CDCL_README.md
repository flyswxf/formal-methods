...
```bash
python3 benchmark_compare.py --cdcl Checkers/cdcl_solver --minisat Baseline/minisat/build/minisat --dataset Datasets/cdcl_dimacs/large/mini --timeout 300
```

```bash
python3 benchmark_compare.py --cdcl Checkers/cdcl_solver --minisat Baseline/minisat/build/minisat --dataset Datasets/cdcl_dimacs/large/mini --timeout 300 --output mini_results.json
```
...
- Linux：`Baseline/minisat/build/minisat`
...
```powershell
python benchmark_compare.py --cdcl Checkers\cdcl_solver.exe --minisat Baseline\minisat\build\minisat.exe --dataset Datasets\cdcl_dimacs\large\mini --timeout 300 --output bench_results.json
```
